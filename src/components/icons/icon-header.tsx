import { colorPoint, colorWhite } from '@/constants/theme'

interface SvgHeadrProps {
  width?: number
  height?: number
  circleborder?: string
  heartborder?: string
...
export default function IconHeader({
  width = 24,
  height = 24,
  circleborder = colorPoint,
  heartborder = colorWhite,
  circleBgColor = colorPoint,
  heartBgColor = colorWhite,
}: SvgHeadrProps) {
  return (
